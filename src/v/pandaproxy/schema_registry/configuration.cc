...
configuration::configuration()
  ...
  , mode_mutability(
      *this,
      "mode_mutability",
      "Enable modifications to the read-only `mode` of the Schema Registry. "
      "When "
      "set to `true`, the entire Schema Registry or its subjects can be "
      "switched "
      "to `READONLY` or `READWRITE`. This property is useful for preventing "
      "unwanted changes to the entire Schema Registry or specific subjects.",
      {},
      true)
